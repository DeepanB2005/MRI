  ...
  return (
    ...
    <div className="sm:w-120 xl:w-130 h-[600px] p-5 bg-gradient-to-t from-red-200 to-green-200 mx-auto mt-10 rounded-3xl shadow-2xl" >
      <div className='p-3 bg-gradient-to-r from-yellow-100 to-orange-200 w-full h-full rounded-2xl'> 
        <div className='h-124'></div>
        <div className='flex'>
        <input type='text' value={ms} onChange={(l)=>setms(l.target.value)} className='flex flex-col h-10 w-80 bg-blue-100 rounded-l-2xl p-3 border-2 border-blue-300 hover:bg-amber-100 placeholder:enter your query' />
        <button onClick={send} className='bg-blue-400 w-20 h-10 rounded-r-3xl flex flex-col border-green-400 text-center p-2 text-violet-500 font-extrabold hover:cursor-crosshair'>ASK</button>
      </div>
      </div>
    </div>
    </>
